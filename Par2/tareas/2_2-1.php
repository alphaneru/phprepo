...
<head>
    ...
    <title>Evaluando Una Función Rara</title>
</head>
...
<body>
    ...
    <div class="salida">
        ...
        <?php
        if ($_POST) {
            echo formula($_POST["saquenmedephpplz:c"]);
        } else {
